...
// BEEM Begin: We want our own allocation functions
#define BEEM
#if defined(BEEM)
...
#define _ogg_malloc  EG_malloc
#define _ogg_calloc  EG_calloc
#define _ogg_realloc EG_realloc
#define _ogg_free    EG_free
#else
