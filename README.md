...
Welcome to the release of the source code for E.X.P.L.O.R.: A New World. This repository includes the game code and demo content.

It is recommended that when cloning this repo you use the --recursive option to get the engine along with it.
